// File: /src/components/TestComponents/WeatherCard.js
import React from 'react'
import './WeatherCard.css'

const WeatherCard = ({ city, temperature, windspeed, aqi, precipitation, humidity, realfeel }) => {
      ...
      <svg
        ...
        >
          <image id="image0"
            ...
            x="0" y="0"
            href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAA
                "/>
        </svg>

        <div class="main">{temperature} °F</div>
        ...
        <div class="card2">
            <div class="upper">
                ...
                <div class="air">
                    <div class="airtext">Wind<br />{windspeed} MPH</div>
            ...
            <div class="lower">
                <div class="aqi">
                  <svg class="aqisvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xmlSpace="preserve">  <image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                    ...
                    <div class="aqitext">AQI<br />{aqi}</div>
                </div> 

                <div class="realfeel">
                  <svg class="rfsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xmlSpace="preserve">  <image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                    ...
                    <div class="realfeeltext">Real Feel<br />{realfeel} °F</div>
                </div> 
                ...
                <div class="pressure">
                  <svg class="pressuresvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xmlSpace="preserve">  <image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                    ...
                    <div class="pressuretext">Precipitation Chance:<br />{precipitation}%</div>
                </div>
...
} // <--- WeatherCard() function ends here
